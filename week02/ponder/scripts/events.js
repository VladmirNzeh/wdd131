...
function manageTasks(event) {
    // add they click the delete or complete icon?
    ...
    // because we added 'data-actions="delete" to each icon in a task we can access a dataset property on our target (e.target.dataset.acion)
